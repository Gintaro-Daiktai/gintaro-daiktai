...
import { DollarSign, Ticket, Users, Loader2, Calendar, BarChart3 } from "lucide-react"
...
export default function LotteryStatisticsPage() {
  ...
  const [statistics, setStatistics] = useState<LotteryStatisticsDto | null>(null);
              ...
              <div className="flex justify-center items-center gap-4">
                <div>
                  <div className="flex justify-center items-center gap-3 mb-2">
                    <h1 className="text-3xl font-bold tracking-tight">Lottery #{statistics.lotteryId}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="border-accent/20">
              <CardContent className="p-6">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-accent">${statistics.totalRevenue.toLocaleString()}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/20">
              <CardContent className="p-6">
                ...
                <div>
                  <p className="text-sm text-muted-foreground mb-1">Tickets Remaining</p>
                  <p className="text-3xl font-bold">{statistics.ticketsRemaining.toLocaleString()}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/20">
              <CardContent className="p-6">
                ...
                <div>
                  <p className="text-sm text-muted-foreground mb-1">Sell-Through Rate</p>
                  <p className="text-3xl font-bold">{statistics.sellThroughRate.toFixed(1)}%</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-accent/20">
              <CardContent className="p-6">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold">{statistics.uniqueBuyers}</p>
                </div>
              </CardContent>
            </Card>
          </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50">
                  ...
                  <div className="text-right">
                    <p className="text-2xl font-bold">{statistics.duration} days</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Total tickets purchased</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-2xl font-bold">{statistics.ticketsSold}/{statistics.totalTickets}</p>
                    <p className="text-xs text-muted-foreground mt-1">${statistics.ticketPrice} per ticket</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                    ...
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {buyer.ticketsPurchased} tickets • {buyer.odds.toFixed(1)}% odds
                        </p>
                      </div>
                    </div>
                    <div className="text-right">
