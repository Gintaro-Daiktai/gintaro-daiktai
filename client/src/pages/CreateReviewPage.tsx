            ...
            <Card className="max-w-2xl mx-auto text-center">
              <CardContent className="pt-12 pb-12 space-y-6">
                ...
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tight">Thank You for Your Review!</h1>
                  <p className="text-muted-foreground leading-relaxed max-w-md mx-auto">
                    Your feedback helps our community make informed decisions and improves the marketplace for everyone.
                  </p>
                </div>
      ...
      <main className="flex-1">
        <div className="border-b bg-muted/30">
          <div className="container py-8">
            ...
            <p className="text-muted-foreground mt-1">Share your experience with this item</p>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Seller: {item.seller}</p>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Help others by sharing your honest feedback about this item</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      Share details about the item condition, shipping, or overall satisfaction
                    </p>
                  </div>
            ...
            <Card className="bg-muted/50">
              ...
              <CardContent className="space-y-2 text-sm text-muted-foreground">
                <ul className="list-disc list-inside space-y-1 leading-relaxed">
                  ...
                  <li>Focus on the item quality, accuracy of description, and seller communication</li>
